...
<!--
  SINGLE SOURCE OF TRUTH for the AWF runtime skill (ADR-0005).
  Adapters under skill/adapters/ are GENERATED from this file.
  Edit here, then run: python3 skill/generate.py
-->
